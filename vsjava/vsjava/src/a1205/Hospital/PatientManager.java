...
sc.nextLine();
  ...
  System.out.println("/n"+name+"님 , 진료가 접수되었습니다.");
...
public void adminMenu() { //비밀번호 통과한 관리자 메뉴
while(true){
  System.out.println("\n======= 관리자 메뉴 =======\n");
            ...
            switch(choice){
              ...
              case 4:
              return;
              // 메인메뉴에서 3번을 선택하면 adminMenu()가 실행
              // 4를 선택하면 리턴을 통해 adminMenu()의 실행종료하고
              // 호출된 위치 (메인메뉴)로 돌아옵니다.

              default:
              System.out.println("잘못 입력했어요. 다시입력해주세요");
              break;
              }
              }
              }
            ...
            private void cancelAppoint() {
              System.out.println("등록된정보를 삭제하고 싶은 환자이름");
              ...
              for(Patient patient: patients){
                if (patient.getName().equalsIgnoreCase(cancelName)) {
                  ...
                  System.out.println("/n"+cancelName+"님의 정보삭제");
                  patientFound=true;
                  break;
                }
              }}
            ...
            for(Patient patient: patients){
              System.out.println(patient.toString());
                ...
                if(patients.isEmpty()){//페이션츠에 리스트가 아무것도 없으면
